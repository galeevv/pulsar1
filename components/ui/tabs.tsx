  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-full p-1 text-muted-foreground group-data-horizontal/tabs:h-9 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col group-data-vertical/tabs:rounded-2xl data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        outline: "gap-1 rounded-lg border border-border bg-transparent",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=outline]/tabs-list:hover:bg-background/40 group-data-[variant=outline]/tabs-list:data-active:border-border group-data-[variant=outline]/tabs-list:data-active:bg-background",
