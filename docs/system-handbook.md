...
- `XUI_MANAGED_INBOUND_IDS` (comma-separated inbound IDs; when set, one 3x-ui client is attached to every listed inbound)
- `XUI_BACKUP_INBOUND_ID` (optional; if set, provisioning creates backup node in same subscription)
- `XUI_API_TOKEN` (preferred for GE manager API access)
- `XUI_USERNAME`
- `XUI_PASSWORD`
- `XUI_PANEL_BASIC_AUTH_USERNAME`
- `XUI_PANEL_BASIC_AUTH_PASSWORD`
- `XUI_SUBSCRIPTION_BASE_URL`
- `XUI_SUBSCRIPTION_LUNAR_HOST`
- `XUI_SUBSCRIPTION_LUNAR_PORT`
- `XUI_SUBSCRIPTION_LUNAR_REMARK`
- `XUI_SUBSCRIPTION_NOVA_HOST`
- `XUI_SUBSCRIPTION_NOVA_PORT`
- `XUI_SUBSCRIPTION_NOVA_REMARK`
- `XUI_SUBSCRIPTION_NEXUS_HOST`
- `XUI_SUBSCRIPTION_NEXUS_PORT`
- `XUI_SUBSCRIPTION_NEXUS_REMARK`
- `XUI_CLIENT_FLOW`
- `XUI_EMAIL_PREFIX`
- `XUI_TIMEOUT_MS`
- `XUI_VERIFY_TLS`
